...
export interface Editor extends ObsidianEditor {
    ...
    markText(from: { line: number; ch: number }, to: { line: number; ch: number }, options: { className: string }): { clear: () => void };
    cm: {
        setSelectionRange: (from: { line: number; ch: number }, to: { line: number; ch: number }) => void;
    };
}