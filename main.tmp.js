...
// src/RecenterCursorComponent.ts
var import_view = require("@codemirror/view");
var RecenterCursorComponent = class {
...
var KillAndYankComponent = class {
  ...
  selectAndAddRegionToKillRing(editor) {
...
// src/MultiCursorComponent.ts
var MultiCursorComponent = class {
  constructor(addCommand) {
    this.addCommand = addCommand;
...
// src/SwapComponent.ts
var SwapComponent = class {
  constructor(addCommand) {
    this.addCommand = addCommand;
    this.registerCommands();
  }
